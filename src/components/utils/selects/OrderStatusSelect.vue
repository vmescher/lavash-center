...
export default defineComponent({
	...
	props: {
		...
		label: {
			type: String,
			default: 'Статус заказа',
		},
		placeholder: {
			type: String,
			default: 'Выберите статус заказа',
		},
		readOnly: {
			type: Boolean,
			default: () => false,
