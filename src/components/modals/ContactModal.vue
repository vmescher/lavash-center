...
<template>
	<BaseModal id="contact-us-modal" v-slot="{close}">
		<section class="modal modal--wide">
			...
			<p class="modal__text">Вы можете оставить свои контактные данные и мы вам перезвоним. Также вы всегда можете позвонить нам сами по номеру <a href="tel:+79953353737">8 995 335 37 37</a>.</p>
